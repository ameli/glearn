...
__all__ = ['generate_sparse_correlation']
...
def _ball_radius(volume, dimension):
    ...
    # Compute gamma functio of dimension/2+1
    gamma = gamma_function(dimension)
