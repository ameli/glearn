...
/* BEGIN: Cython Metadata
{
    "distutils": {
        ...
        "language": "c++",
        "name": "glearn._correlation._sparse_array_utilities",
        "sources": [
            "./glearn/_correlation/_sparse_array_utilities.pyx"
        ]
    },
    "module_name": "glearn._correlation._sparse_array_utilities"
}
END: Cython Metadata */
...
#define __PYX_HAVE__glearn___correlation___sparse_array_utilities
#define __PYX_HAVE_API__glearn___correlation___sparse_array_utilities
/* Early includes */
#include <string.h>
#include <stdlib.h>
#include "pythread.h"
...
/* Module declarations from 'glearn._correlation._sparse_array_utilities' */
...
#define __Pyx_MODULE_NAME "glearn._correlation._sparse_array_utilities"
extern int __pyx_module_is_main_glearn___correlation___sparse_array_utilities;
int __pyx_module_is_main_glearn___correlation___sparse_array_utilities = 0;

/* Implementation of 'glearn._correlation._sparse_array_utilities' */
...
static const char __pyx_k_extend_arrays[] = "extend_arrays";
...
static PyObject *__pyx_n_u_extend_arrays;
...
/* "glearn/_correlation/_sparse_array_utilities.pyx":23
 * # =============
 * 
...
static void __pyx_f_6glearn_12_correlation_23_sparse_array_utilities_extend_arrays(__Pyx_memviewslice __pyx_v_max_nnz, __Pyx_memviewslice __pyx_v_nnz, long **__pyx_v_pp_matrix_row_indices, long **__pyx_v_pp_matrix_column_indices, double **__pyx_v_pp_matrix_data) {
  long __pyx_v_ext_nnz;
  long *__pyx_v_ext_matrix_row_indices;
  long *__pyx_v_ext_matrix_column_indices;
  double *__pyx_v_ext_matrix_data;
  int __pyx_v_i;
  ...
  /* "glearn/_correlation/_sparse_array_utilities.pyx":34
 * 
 ...
 */
  __pyx_t_1 = 0;
  __pyx_v_ext_nnz = ((*((long *) ( /* dim=0 */ (__pyx_v_max_nnz.data + __pyx_t_1 * __pyx_v_max_nnz.strides[0]) ))) * 2);

  /* "glearn/_correlation/_sparse_array_utilities.pyx":37
 * 
 *     # Allocate extended arrays
 ...
 *         ext_nnz * sizeof(long))
 */
  __pyx_v_ext_matrix_row_indices = ((long *)malloc((__pyx_v_ext_nnz * (sizeof(long)))));

  /* "glearn/_correlation/_sparse_array_utilities.pyx":38
 *     # Allocate extended arrays
 *     cdef long* ext_matrix_row_indices = <long*> malloc(ext_nnz * sizeof(long))
 *     cdef long* ext_matrix_column_indices = <long*> malloc(             # <<<<<<<<<<<<<<
 *         ext_nnz * sizeof(long))
 ...
 */
  __pyx_v_ext_matrix_column_indices = ((long *)malloc((__pyx_v_ext_nnz * (sizeof(long)))));

  /* "glearn/_correlation/_sparse_array_utilities.pyx":40
 *     cdef long* ext_matrix_column_indices = <long*> malloc(
 *         ext_nnz * sizeof(long))
 *     cdef double* ext_matrix_data = <double*> malloc(ext_nnz * sizeof(double))             # <<<<<<<<<<<<<<
 * 
 ...
 */
  __pyx_v_ext_matrix_data = ((double *)malloc((__pyx_v_ext_nnz * (sizeof(double)))));

  /* "glearn/_correlation/_sparse_array_utilities.pyx":44
 *     # Copy contents of previous arrays
 *     cdef int i
 ...
 */
  __pyx_t_1 = 0;
  __pyx_t_2 = (*((long *) ( /* dim=0 */ (__pyx_v_nnz.data + __pyx_t_1 * __pyx_v_nnz.strides[0]) )));
  __pyx_t_3 = __pyx_t_2;
  for (__pyx_t_4 = 0; __pyx_t_4 < __pyx_t_3; __pyx_t_4+=1) {
    __pyx_v_i = __pyx_t_4;

    /* "glearn/_correlation/_sparse_array_utilities.pyx":45
 *     cdef int i
 *     for i in range(nnz[0]):
 *         ext_matrix_row_indices[i] = pp_matrix_row_indices[0][i]             # <<<<<<<<<<<<<<
 *         ext_matrix_column_indices[i] = pp_matrix_column_indices[0][i]
 ...
 */
    (__pyx_v_ext_matrix_row_indices[__pyx_v_i]) = ((__pyx_v_pp_matrix_row_indices[0])[__pyx_v_i]);

    /* "glearn/_correlation/_sparse_array_utilities.pyx":46
 *     for i in range(nnz[0]):
 *         ext_matrix_row_indices[i] = pp_matrix_row_indices[0][i]
 *         ext_matrix_column_indices[i] = pp_matrix_column_indices[0][i]             # <<<<<<<<<<<<<<
 *         ext_matrix_data[i] = pp_matrix_data[0][i]
 * 
 */
    (__pyx_v_ext_matrix_column_indices[__pyx_v_i]) = ((__pyx_v_pp_matrix_column_indices[0])[__pyx_v_i]);

    /* "glearn/_correlation/_sparse_array_utilities.pyx":47
 *         ext_matrix_row_indices[i] = pp_matrix_row_indices[0][i]
 *         ext_matrix_column_indices[i] = pp_matrix_column_indices[0][i]
 *         ext_matrix_data[i] = pp_matrix_data[0][i]             # <<<<<<<<<<<<<<
 * 
 ...
 */
    (__pyx_v_ext_matrix_data[__pyx_v_i]) = ((__pyx_v_pp_matrix_data[0])[__pyx_v_i]);
  }

  /* "glearn/_correlation/_sparse_array_utilities.pyx":50
 * 
 *     # Delete previous arrays
 ...
 */
  free((__pyx_v_pp_matrix_row_indices[0]));

  /* "glearn/_correlation/_sparse_array_utilities.pyx":51
 *     # Delete previous arrays
 *     free(pp_matrix_row_indices[0])
 *     free(pp_matrix_column_indices[0])             # <<<<<<<<<<<<<<
 *     free(pp_matrix_data[0])
 * 
 */
  free((__pyx_v_pp_matrix_column_indices[0]));

  /* "glearn/_correlation/_sparse_array_utilities.pyx":52
 *     free(pp_matrix_row_indices[0])
 *     free(pp_matrix_column_indices[0])
 *     free(pp_matrix_data[0])             # <<<<<<<<<<<<<<
 * 
 *     # Transfer pointers
 */
  free((__pyx_v_pp_matrix_data[0]));

  /* "glearn/_correlation/_sparse_array_utilities.pyx":55
 * 
 *     # Transfer pointers
 ...
 */
  (__pyx_v_pp_matrix_row_indices[0]) = __pyx_v_ext_matrix_row_indices;

  /* "glearn/_correlation/_sparse_array_utilities.pyx":56
 *     # Transfer pointers
 *     pp_matrix_row_indices[0] = ext_matrix_row_indices
 *     pp_matrix_column_indices[0] = ext_matrix_column_indices             # <<<<<<<<<<<<<<
 *     pp_matrix_data[0] = ext_matrix_data
 * 
 */
  (__pyx_v_pp_matrix_column_indices[0]) = __pyx_v_ext_matrix_column_indices;

  /* "glearn/_correlation/_sparse_array_utilities.pyx":57
 *     pp_matrix_row_indices[0] = ext_matrix_row_indices
 *     pp_matrix_column_indices[0] = ext_matrix_column_indices
 *     pp_matrix_data[0] = ext_matrix_data             # <<<<<<<<<<<<<<
 * 
 *     # Update size
 */
  (__pyx_v_pp_matrix_data[0]) = __pyx_v_ext_matrix_data;

  /* "glearn/_correlation/_sparse_array_utilities.pyx":60
 * 
 *     # Update size
 *     max_nnz[0] = ext_nnz             # <<<<<<<<<<<<<<
 */
  __pyx_t_1 = 0;
  *((long *) ( /* dim=0 */ (__pyx_v_max_nnz.data + __pyx_t_1 * __pyx_v_max_nnz.strides[0]) )) = __pyx_v_ext_nnz;
...
static PyTypeObject __pyx_type___pyx_array = {
  ...
  "glearn._correlation._sparse_array_utilities.array", /*tp_name*/
...
static PyTypeObject __pyx_type___pyx_MemviewEnum = {
  PyVarObject_HEAD_INIT(0, 0)
  "glearn._correlation._sparse_array_utilities.Enum", /*tp_name*/
...
static PyTypeObject __pyx_type___pyx_memoryview = {
  PyVarObject_HEAD_INIT(0, 0)
  "glearn._correlation._sparse_array_utilities.memoryview", /*tp_name*/
...
static PyTypeObject __pyx_type___pyx_memoryviewslice = {
  PyVarObject_HEAD_INIT(0, 0)
  "glearn._correlation._sparse_array_utilities._memoryviewslice", /*tp_name*/
...
static int __pyx_pymod_exec__sparse_array_utilities(PyObject* module); /*proto*/
static PyModuleDef_Slot __pyx_moduledef_slots[] = {
  {Py_mod_create, (void*)__pyx_pymod_create},
  {Py_mod_exec, (void*)__pyx_pymod_exec__sparse_array_utilities},
  {0, NULL}
};
#endif
...
static __Pyx_StringTabEntry __pyx_string_tab[] = {
  ...
  {&__pyx_n_u_extend_arrays, __pyx_k_extend_arrays, sizeof(__pyx_k_extend_arrays), 0, 1, 0, 1},
...
static int __Pyx_modinit_function_export_code(void) {
  ...
  if (__Pyx_ExportFunction("extend_arrays", (void (*)(void))__pyx_f_6glearn_12_correlation_23_sparse_array_utilities_extend_arrays, "void (__Pyx_memviewslice, __Pyx_memviewslice, long **, long **, double **)") < 0) __PYX_ERR(0, 1, __pyx_L1_error)
  __Pyx_RefNannyFinishContext();
  return 0;
  __pyx_L1_error:;
  __Pyx_RefNannyFinishContext();
...
#if PY_MAJOR_VERSION < 3
__Pyx_PyMODINIT_FUNC init_sparse_array_utilities(void) CYTHON_SMALL_CODE; /*proto*/
__Pyx_PyMODINIT_FUNC init_sparse_array_utilities(void)
#else
__Pyx_PyMODINIT_FUNC PyInit__sparse_array_utilities(void) CYTHON_SMALL_CODE; /*proto*/
__Pyx_PyMODINIT_FUNC PyInit__sparse_array_utilities(void)
#if CYTHON_PEP489_MULTI_PHASE_INIT
{
...
static CYTHON_SMALL_CODE int __pyx_pymod_exec__sparse_array_utilities(PyObject *__pyx_pyinit_module)
#endif
#endif
{
  PyObject *__pyx_t_1 = NULL;
  ...
  if (__pyx_m) {
    ...
    PyErr_SetString(PyExc_RuntimeError, "Module '_sparse_array_utilities' has already been imported. Re-initialisation is not supported.");
    return -1;
  }
  #elif PY_MAJOR_VERSION >= 3
...
if (!__Pyx_RefNanny) {
...
#endif
  __Pyx_RefNannySetupContext("__Pyx_PyMODINIT_FUNC PyInit__sparse_array_utilities(void)", 0);
  ...
  #else
  #if PY_MAJOR_VERSION < 3
  __pyx_m = Py_InitModule4("_sparse_array_utilities", __pyx_methods, 0, 0, PYTHON_API_VERSION); Py_XINCREF(__pyx_m);
  #else
  ...
  #endif
  if (__pyx_module_is_main_glearn___correlation___sparse_array_utilities) {
    if (PyObject_SetAttr(__pyx_m, __pyx_n_s_name_2, __pyx_n_s_main) < 0) __PYX_ERR(0, 1, __pyx_L1_error)
  }
  #if PY_MAJOR_VERSION >= 3
  {
    PyObject *modules = PyImport_GetModuleDict(); if (unlikely(!modules)) __PYX_ERR(0, 1, __pyx_L1_error)
    if (!PyDict_GetItemString(modules, "glearn._correlation._sparse_array_utilities")) {
      if (unlikely(PyDict_SetItemString(modules, "glearn._correlation._sparse_array_utilities", __pyx_m) < 0)) __PYX_ERR(0, 1, __pyx_L1_error)
    }
  }
  #endif
  /*--- Builtin init code ---*/
  ...
  /* "glearn/_correlation/_sparse_array_utilities.pyx":16
 ...
 */
  ...
  __Pyx_GOTREF(__pyx_t_1);
  __Pyx_INCREF(__pyx_n_u_extend_arrays);
  __Pyx_GIVEREF(__pyx_n_u_extend_arrays);
  PyList_SET_ITEM(__pyx_t_1, 0, __pyx_n_u_extend_arrays);
  if (PyDict_SetItem(__pyx_d, __pyx_n_s_all, __pyx_t_1) < 0) __PYX_ERR(0, 16, __pyx_L1_error)
  __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;

  /* "glearn/_correlation/_sparse_array_utilities.pyx":1
 ...
 */
  ...
  if (__pyx_m) {
    if (__pyx_d) {
      __Pyx_AddTraceback("init glearn._correlation._sparse_array_utilities", __pyx_clineno, __pyx_lineno, __pyx_filename);
    }
    Py_CLEAR(__pyx_m);
  } else if (!PyErr_Occurred()) {
    PyErr_SetString(PyExc_ImportError, "init glearn._correlation._sparse_array_utilities");
  }
  __pyx_L0:;
  __Pyx_RefNannyFinishContext();
  #if CYTHON_PEP489_MULTI_PHASE_INIT
