...
/* BEGIN: Cython Metadata
{
    "distutils": {
        ...
        "language": "c++",
        "name": "glearn._correlation._compute_sparse_correlation",
        "sources": [
            "./glearn/_correlation/_compute_sparse_correlation.pyx"
        ]
    },
    "module_name": "glearn._correlation._compute_sparse_correlation"
}
END: Cython Metadata */
...
#define __PYX_HAVE__glearn___correlation___compute_sparse_correlation
#define __PYX_HAVE_API__glearn___correlation___compute_sparse_correlation
/* Early includes */
#include "pythread.h"
#include <string.h>
#include <stdlib.h>
...
/* Module declarations from 'glearn._correlation._euclidean_distance' */
static double (*__pyx_f_6glearn_12_correlation_19_euclidean_distance_euclidean_distance)(__Pyx_memviewslice, __Pyx_memviewslice, __Pyx_memviewslice, int const ); /*proto*/

/* Module declarations from 'glearn._correlation._compute_sparse_correlation' */
...
#define __Pyx_MODULE_NAME "glearn._correlation._compute_sparse_correlation"
extern int __pyx_module_is_main_glearn___correlation___compute_sparse_correlation;
int __pyx_module_is_main_glearn___correlation___compute_sparse_correlation = 0;

/* Implementation of 'glearn._correlation._compute_sparse_correlation' */
...
static const char __pyx_k_compute_sparse_correlation[] = "compute_sparse_correlation";
...
static const char __pyx_k_compute_sparse_correlation_hessi[] = "compute_sparse_correlation_hessian";
static const char __pyx_k_compute_sparse_correlation_jacob[] = "compute_sparse_correlation_jacobian";
...
static PyObject *__pyx_n_u_compute_sparse_correlation;
static PyObject *__pyx_n_u_compute_sparse_correlation_hessi;
static PyObject *__pyx_n_u_compute_sparse_correlation_jacob;
...
/* "glearn/_correlation/_compute_sparse_correlation.pyx":28
 * @boundscheck(False)
 * @wraparound(False)
...
static double __pyx_f_6glearn_12_correlation_27_compute_sparse_correlation_compute_sparse_correlation(__Pyx_memviewslice __pyx_v_point1, __Pyx_memviewslice __pyx_v_point2, int const __pyx_v_dimension, __Pyx_memviewslice __pyx_v_scale, struct __pyx_obj_6glearn_7kernels_6kernel_Kernel *__pyx_v_kernel) {
  double __pyx_v_distance;
  double __pyx_r;

  /* "glearn/_correlation/_compute_sparse_correlation.pyx":38
 *     """
 * 
 ...
 */
  __pyx_v_distance = __pyx_f_6glearn_12_correlation_19_euclidean_distance_euclidean_distance(__pyx_v_point1, __pyx_v_point2, __pyx_v_scale, __pyx_v_dimension);

  /* "glearn/_correlation/_compute_sparse_correlation.pyx":40
 *     cdef double distance = euclidean_distance(point1, point2, scale, dimension)
 * 
 *     return kernel.cy_kernel(distance)             # <<<<<<<<<<<<<<
 * 
 * 
 */
  __pyx_r = ((struct __pyx_vtabstruct_6glearn_7kernels_6kernel_Kernel *)__pyx_v_kernel->__pyx_vtab)->cy_kernel(__pyx_v_kernel, __pyx_v_distance);
  goto __pyx_L0;
...
/* "glearn/_correlation/_compute_sparse_correlation.pyx":49
 * @boundscheck(False)
 * @wraparound(False)
...
static void __pyx_f_6glearn_12_correlation_27_compute_sparse_correlation_compute_sparse_correlation_jacobian(__Pyx_memviewslice __pyx_v_points, int const __pyx_v_dimension, __Pyx_memviewslice __pyx_v_scale, struct __pyx_obj_6glearn_7kernels_6kernel_Kernel *__pyx_v_kernel, int __pyx_v_row, int __pyx_v_index_pointer, __Pyx_memviewslice __pyx_v_matrix_column_indices, __Pyx_memviewslice __pyx_v_matrix_data) {
  int __pyx_v_p;
  int __pyx_v_column;
  double __pyx_v_distance;
  double __pyx_v_d1_kernel;
  double __pyx_v_d1_distance;
  ...
  /* "glearn/_correlation/_compute_sparse_correlation.pyx":67
 * 
 ...
 */
  __pyx_t_1 = __pyx_v_index_pointer;
  __pyx_v_column = (*((int *) ( /* dim=0 */ (__pyx_v_matrix_column_indices.data + __pyx_t_1 * __pyx_v_matrix_column_indices.strides[0]) )));

  /* "glearn/_correlation/_compute_sparse_correlation.pyx":70
 * 
 *     # The case at zero distance.
 *     if row == column:             # <<<<<<<<<<<<<<
 ...
 */
  __pyx_t_2 = ((__pyx_v_row == __pyx_v_column) != 0);
  if (__pyx_t_2) {

    /* "glearn/_correlation/_compute_sparse_correlation.pyx":71
 *     # The case at zero distance.
 *     if row == column:
 *         for p in range(dimension):             # <<<<<<<<<<<<<<
 *             matrix_data[p, index_pointer] = 0.0
 ...
 */
    ...
    for (__pyx_t_5 = 0; __pyx_t_5 < __pyx_t_4; __pyx_t_5+=1) {
      ...
      /* "glearn/_correlation/_compute_sparse_correlation.pyx":72
 *     if row == column:
 *         for p in range(dimension):
 *             matrix_data[p, index_pointer] = 0.0             # <<<<<<<<<<<<<<
 *         return
 ...
 */
      __pyx_t_1 = __pyx_v_p;
      __pyx_t_6 = __pyx_v_index_pointer;
      *((double *) ( /* dim=1 */ ((char *) (((double *) ( /* dim=0 */ (__pyx_v_matrix_data.data + __pyx_t_1 * __pyx_v_matrix_data.strides[0]) )) + __pyx_t_6)) )) = 0.0;
    }

    /* "glearn/_correlation/_compute_sparse_correlation.pyx":73
 *         for p in range(dimension):
 *             matrix_data[p, index_pointer] = 0.0
 *         return             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  /* "glearn/_correlation/_compute_sparse_correlation.pyx":76
 * 
 *     cdef double distance = euclidean_distance(
 ...
 */
  __pyx_t_7.data = __pyx_v_points.data;
  __pyx_t_7.memview = __pyx_v_points.memview;
...
__pyx_t_7.shape[0] = __pyx_v_points.shape[1];
__pyx_t_7.strides[0] = __pyx_v_points.strides[1];
    __pyx_t_7.suboffsets[0] = -1;

__pyx_t_8.data = __pyx_v_points.data;
  __pyx_t_8.memview = __pyx_v_points.memview;
  __PYX_INC_MEMVIEW(&__pyx_t_8, 0);
  {
    Py_ssize_t __pyx_tmp_idx = __pyx_v_column;
    Py_ssize_t __pyx_tmp_stride = __pyx_v_points.strides[0];
        __pyx_t_8.data += __pyx_tmp_idx * __pyx_tmp_stride;
}

__pyx_t_8.shape[0] = __pyx_v_points.shape[1];
__pyx_t_8.strides[0] = __pyx_v_points.strides[1];
    __pyx_t_8.suboffsets[0] = -1;

__pyx_v_distance = __pyx_f_6glearn_12_correlation_19_euclidean_distance_euclidean_distance(__pyx_t_7, __pyx_t_8, __pyx_v_scale, __pyx_v_dimension);

  /* "glearn/_correlation/_compute_sparse_correlation.pyx":75
 *         return
 * 
 *     cdef double distance = euclidean_distance(             # <<<<<<<<<<<<<<
 *             points[row][:], points[column][:], scale, dimension)
 ...
 */
  ...
  /* "glearn/_correlation/_compute_sparse_correlation.pyx":78
 *             points[row][:], points[column][:], scale, dimension)
 * 
 *     cdef double d1_kernel = kernel.cy_kernel_first_derivative(distance)             # <<<<<<<<<<<<<<
 * 
 ...
 */
  __pyx_v_d1_kernel = ((struct __pyx_vtabstruct_6glearn_7kernels_6kernel_Kernel *)__pyx_v_kernel->__pyx_vtab)->cy_kernel_first_derivative(__pyx_v_kernel, __pyx_v_distance);

  /* "glearn/_correlation/_compute_sparse_correlation.pyx":83
 ...
 */
  ...
  for (__pyx_t_5 = 0; __pyx_t_5 < __pyx_t_4; __pyx_t_5+=1) {
    ...
    /* "glearn/_correlation/_compute_sparse_correlation.pyx":86
 * 
 *         # derivative of distance w.r.t the p-th component of scale
 ...
 */
    ...
    /* "glearn/_correlation/_compute_sparse_correlation.pyx":87
 *         # derivative of distance w.r.t the p-th component of scale
 *         d1_distance = -(points[row, p] - points[column, p])**2 / \
 *             (distance * scale[p]**3)             # <<<<<<<<<<<<<<
 * 
 ...
 * 
 */
    __pyx_v_d1_distance = ((-pow(((*((double const  *) ( /* dim=1 */ ((char *) (((double const  *) ( /* dim=0 */ (__pyx_v_points.data + __pyx_t_6 * __pyx_v_points.strides[0]) )) + __pyx_t_1)) ))) - (*((double const  *) ( /* dim=1 */ ((char *) (((double const  *) ( /* dim=0 */ (__pyx_v_points.data + __pyx_t_9 * __pyx_v_points.strides[0]) )) + __pyx_t_10)) )))), 2.0)) / (__pyx_v_distance * pow(((double)(*((double const  *) ( /* dim=0 */ (__pyx_v_scale.data + __pyx_t_11 * __pyx_v_scale.strides[0]) )))), 3.0)));

    /* "glearn/_correlation/_compute_sparse_correlation.pyx":90
 * 
 *         # Derivative of correlation
 ...
 */
    __pyx_t_11 = __pyx_v_p;
    __pyx_t_10 = __pyx_v_index_pointer;
    *((double *) ( /* dim=1 */ ((char *) (((double *) ( /* dim=0 */ (__pyx_v_matrix_data.data + __pyx_t_11 * __pyx_v_matrix_data.strides[0]) )) + __pyx_t_10)) )) = (__pyx_v_d1_kernel * __pyx_v_d1_distance);
  }
...
/* "glearn/_correlation/_compute_sparse_correlation.pyx":99
 * @boundscheck(False)
 * @wraparound(False)
...
static void __pyx_f_6glearn_12_correlation_27_compute_sparse_correlation_compute_sparse_correlation_hessian(__Pyx_memviewslice __pyx_v_points, int const __pyx_v_dimension, __Pyx_memviewslice __pyx_v_scale, struct __pyx_obj_6glearn_7kernels_6kernel_Kernel *__pyx_v_kernel, int __pyx_v_row, int __pyx_v_index_pointer, __Pyx_memviewslice __pyx_v_matrix_column_indices, __Pyx_memviewslice __pyx_v_matrix_data) {
  int __pyx_v_p;
  int __pyx_v_q;
  int __pyx_v_column;
  double __pyx_v_distance;
  double __pyx_v_d1_kernel;
  double __pyx_v_d2_kernel;
  double __pyx_v_dp_distance;
  double __pyx_v_dq_distance;
  double __pyx_v_dpq_distance;
  Py_ssize_t __pyx_t_1;
  int __pyx_t_2;
  int __pyx_t_3;
  int __pyx_t_4;
  ...
  /* "glearn/_correlation/_compute_sparse_correlation.pyx":116
 * 
 *     # Find column of csr matrix
 *     cdef int column = matrix_column_indices[index_pointer]             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  /* "glearn/_correlation/_compute_sparse_correlation.pyx":119
 * 
 *     # The case at zero distance
 *     if row == column:             # <<<<<<<<<<<<<<
 *         for p in range(dimension):
 ...
 */
  ...
  if (__pyx_t_2) {
    ...
    /* "glearn/_correlation/_compute_sparse_correlation.pyx":120
 *     # The case at zero distance
 *     if row == column:
 *         for p in range(dimension):             # <<<<<<<<<<<<<<
 *             for q in range(dimension):
 ...
 */
    ...
    for (__pyx_t_5 = 0; __pyx_t_5 < __pyx_t_4; __pyx_t_5+=1) {
      ...
      /* "glearn/_correlation/_compute_sparse_correlation.pyx":121
 *     if row == column:
 *         for p in range(dimension):
 *             for q in range(dimension):             # <<<<<<<<<<<<<<
 *                 matrix_data[p, q, index_pointer] = 0.0
 ...
 */
      ...
      for (__pyx_t_8 = 0; __pyx_t_8 < __pyx_t_7; __pyx_t_8+=1) {
        ...
        /* "glearn/_correlation/_compute_sparse_correlation.pyx":122
 *         for p in range(dimension):
 *             for q in range(dimension):
 *                 matrix_data[p, q, index_pointer] = 0.0             # <<<<<<<<<<<<<<
 *         return
 ...
 */
        ...
        __pyx_t_9 = __pyx_v_q;
        __pyx_t_10 = __pyx_v_index_pointer;
        *((double *) ( /* dim=2 */ ((char *) (((double *) ( /* dim=1 */ (( /* dim=0 */ (__pyx_v_matrix_data.data + __pyx_t_1 * __pyx_v_matrix_data.strides[0]) ) + __pyx_t_9 * __pyx_v_matrix_data.strides[1]) )) + __pyx_t_10)) )) = 0.0;
      }
    }

    /* "glearn/_correlation/_compute_sparse_correlation.pyx":123
 *             for q in range(dimension):
 *                 matrix_data[p, q, index_pointer] = 0.0
 *         return             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  /* "glearn/_correlation/_compute_sparse_correlation.pyx":126
 * 
 *     cdef double distance = euclidean_distance(
 *             points[row][:], points[column][:], scale, dimension)             # <<<<<<<<<<<<<<
 * 
 *     cdef double d1_kernel = kernel.cy_kernel_first_derivative(distance)
 */
  __pyx_t_11.data = __pyx_v_points.data;
  __pyx_t_11.memview = __pyx_v_points.memview;
...
__pyx_t_11.shape[0] = __pyx_v_points.shape[1];
__pyx_t_11.strides[0] = __pyx_v_points.strides[1];
    __pyx_t_11.suboffsets[0] = -1;

__pyx_t_12.data = __pyx_v_points.data;
  __pyx_t_12.memview = __pyx_v_points.memview;
...
__pyx_t_12.shape[0] = __pyx_v_points.shape[1];
__pyx_t_12.strides[0] = __pyx_v_points.strides[1];
    __pyx_t_12.suboffsets[0] = -1;

__pyx_v_distance = __pyx_f_6glearn_12_correlation_19_euclidean_distance_euclidean_distance(__pyx_t_11, __pyx_t_12, __pyx_v_scale, __pyx_v_dimension);

  /* "glearn/_correlation/_compute_sparse_correlation.pyx":125
 *         return
 * 
 *     cdef double distance = euclidean_distance(             # <<<<<<<<<<<<<<
 *             points[row][:], points[column][:], scale, dimension)
 ...
 */
  ...
  /* "glearn/_correlation/_compute_sparse_correlation.pyx":128
 *             points[row][:], points[column][:], scale, dimension)
 * 
 *     cdef double d1_kernel = kernel.cy_kernel_first_derivative(distance)             # <<<<<<<<<<<<<<
 ...
 */
  ...
  /* "glearn/_correlation/_compute_sparse_correlation.pyx":129
 * 
 *     cdef double d1_kernel = kernel.cy_kernel_first_derivative(distance)
 *     cdef double d2_kernel = kernel.cy_kernel_second_derivative(distance)             # <<<<<<<<<<<<<<
 * 
 *     # Derivative of distance w.r.t one of the components of scale
 */
  __pyx_v_d2_kernel = ((struct __pyx_vtabstruct_6glearn_7kernels_6kernel_Kernel *)__pyx_v_kernel->__pyx_vtab)->cy_kernel_second_derivative(__pyx_v_kernel, __pyx_v_distance);

  /* "glearn/_correlation/_compute_sparse_correlation.pyx":136
 ...
 */
  ...
  for (__pyx_t_5 = 0; __pyx_t_5 < __pyx_t_4; __pyx_t_5+=1) {
    ...
    /* "glearn/_correlation/_compute_sparse_correlation.pyx":137
 * 
 *     for p in range(dimension):
 *         for q in range(p, dimension):             # <<<<<<<<<<<<<<
 * 
 ...
 */
    __pyx_t_6 = __pyx_v_dimension;
    __pyx_t_7 = __pyx_t_6;
    for (__pyx_t_8 = __pyx_v_p; __pyx_t_8 < __pyx_t_7; __pyx_t_8+=1) {
      __pyx_v_q = __pyx_t_8;

      /* "glearn/_correlation/_compute_sparse_correlation.pyx":140
 * 
 *             # derivative of distance w.r.t the p-th component of scale
 ...
 */
      ...
      __pyx_t_9 = __pyx_v_p;
      __pyx_t_1 = __pyx_v_column;
      __pyx_t_13 = __pyx_v_p;

      /* "glearn/_correlation/_compute_sparse_correlation.pyx":141
 *             # derivative of distance w.r.t the p-th component of scale
 *             dp_distance = -(points[row, p] - points[column, p])**2 / \
 *                 (distance * scale[p]**3)             # <<<<<<<<<<<<<<
 * 
 ...
 * 
 */
      __pyx_v_dp_distance = ((-pow(((*((double const  *) ( /* dim=1 */ ((char *) (((double const  *) ( /* dim=0 */ (__pyx_v_points.data + __pyx_t_10 * __pyx_v_points.strides[0]) )) + __pyx_t_9)) ))) - (*((double const  *) ( /* dim=1 */ ((char *) (((double const  *) ( /* dim=0 */ (__pyx_v_points.data + __pyx_t_1 * __pyx_v_points.strides[0]) )) + __pyx_t_13)) )))), 2.0)) / (__pyx_v_distance * pow(((double)(*((double const  *) ( /* dim=0 */ (__pyx_v_scale.data + __pyx_t_14 * __pyx_v_scale.strides[0]) )))), 3.0)));

      /* "glearn/_correlation/_compute_sparse_correlation.pyx":144
 * 
 *             # derivative of distance w.r.t the p-th component of scale
 *             if q == p:             # <<<<<<<<<<<<<<
 ...
 *             else:
 */
      __pyx_t_2 = ((__pyx_v_q == __pyx_v_p) != 0);
      if (__pyx_t_2) {

        /* "glearn/_correlation/_compute_sparse_correlation.pyx":145
 *             # derivative of distance w.r.t the p-th component of scale
 *             if q == p:
 *                 dq_distance = dp_distance             # <<<<<<<<<<<<<<
 *             else:
 ...
 */
        __pyx_v_dq_distance = __pyx_v_dp_distance;
 ...
 */
      ...
      /* "glearn/_correlation/_compute_sparse_correlation.pyx":147
 *                 dq_distance = dp_distance
 *             else:
 *                 dq_distance = -(points[row, q] - points[column, q])**2 / \             # <<<<<<<<<<<<<<
 *                     (distance * scale[q]**3)
 ...
 */
      /*else*/ {
        ...
        /* "glearn/_correlation/_compute_sparse_correlation.pyx":148
 *             else:
 *                 dq_distance = -(points[row, q] - points[column, q])**2 / \
 *                     (distance * scale[q]**3)             # <<<<<<<<<<<<<<
 * 
 ...
 * 
 */
        __pyx_v_dq_distance = ((-pow(((*((double const  *) ( /* dim=1 */ ((char *) (((double const  *) ( /* dim=0 */ (__pyx_v_points.data + __pyx_t_14 * __pyx_v_points.strides[0]) )) + __pyx_t_13)) ))) - (*((double const  *) ( /* dim=1 */ ((char *) (((double const  *) ( /* dim=0 */ (__pyx_v_points.data + __pyx_t_1 * __pyx_v_points.strides[0]) )) + __pyx_t_9)) )))), 2.0)) / (__pyx_v_distance * pow(((double)(*((double const  *) ( /* dim=0 */ (__pyx_v_scale.data + __pyx_t_10 * __pyx_v_scale.strides[0]) )))), 3.0)));
      }
      __pyx_L12:;

      /* "glearn/_correlation/_compute_sparse_correlation.pyx":151
 * 
 *             # Second mixed derivative of distance w.r.t the p and q component
 *             if q == p:             # <<<<<<<<<<<<<<
 ...
 */
      ...
      if (__pyx_t_2) {
        ...
        /* "glearn/_correlation/_compute_sparse_correlation.pyx":152
 *             # Second mixed derivative of distance w.r.t the p and q component
 *             if q == p:
 *                 dpq_distance = ((points[row, p] - points[column, p])**2 /             # <<<<<<<<<<<<<<
 *                                 (distance * scale[p]**3)) * \
 ...
 */
        ...
        /* "glearn/_correlation/_compute_sparse_correlation.pyx":153
 *             if q == p:
 *                 dpq_distance = ((points[row, p] - points[column, p])**2 /
 *                                 (distance * scale[p]**3)) * \             # <<<<<<<<<<<<<<
 *                         (3.0 / scale[p] + dp_distance / distance)
 ...
 */
        ...
        /* "glearn/_correlation/_compute_sparse_correlation.pyx":154
 *                 dpq_distance = ((points[row, p] - points[column, p])**2 /
 *                                 (distance * scale[p]**3)) * \
 *                         (3.0 / scale[p] + dp_distance / distance)             # <<<<<<<<<<<<<<
 *             else:
 ...
 *             else:
 */
        __pyx_v_dpq_distance = ((pow(((*((double const  *) ( /* dim=1 */ ((char *) (((double const  *) ( /* dim=0 */ (__pyx_v_points.data + __pyx_t_10 * __pyx_v_points.strides[0]) )) + __pyx_t_9)) ))) - (*((double const  *) ( /* dim=1 */ ((char *) (((double const  *) ( /* dim=0 */ (__pyx_v_points.data + __pyx_t_1 * __pyx_v_points.strides[0]) )) + __pyx_t_13)) )))), 2.0) / (__pyx_v_distance * pow(((double)(*((double const  *) ( /* dim=0 */ (__pyx_v_scale.data + __pyx_t_14 * __pyx_v_scale.strides[0]) )))), 3.0))) * ((3.0 / ((double)(*((double const  *) ( /* dim=0 */ (__pyx_v_scale.data + __pyx_t_15 * __pyx_v_scale.strides[0]) ))))) + (__pyx_v_dp_distance / __pyx_v_distance)));
 ...
 */
      ...
      /* "glearn/_correlation/_compute_sparse_correlation.pyx":157
 *             else:
 *                 dpq_distance = ((points[row, p] - points[column, p])**2 /
 ...
 */
      /*else*/ {
        ...
        /* "glearn/_correlation/_compute_sparse_correlation.pyx":156
 *                         (3.0 / scale[p] + dp_distance / distance)
 *             else:
 *                 dpq_distance = ((points[row, p] - points[column, p])**2 /             # <<<<<<<<<<<<<<
 *                                 (distance**2 * scale[p]**3)) * dq_distance
 ...
 * 
 */
        __pyx_v_dpq_distance = ((pow(((*((double const  *) ( /* dim=1 */ ((char *) (((double const  *) ( /* dim=0 */ (__pyx_v_points.data + __pyx_t_15 * __pyx_v_points.strides[0]) )) + __pyx_t_14)) ))) - (*((double const  *) ( /* dim=1 */ ((char *) (((double const  *) ( /* dim=0 */ (__pyx_v_points.data + __pyx_t_13 * __pyx_v_points.strides[0]) )) + __pyx_t_1)) )))), 2.0) / (pow(__pyx_v_distance, 2.0) * pow(((double)(*((double const  *) ( /* dim=0 */ (__pyx_v_scale.data + __pyx_t_9 * __pyx_v_scale.strides[0]) )))), 3.0))) * __pyx_v_dq_distance);
      }
      __pyx_L13:;

      /* "glearn/_correlation/_compute_sparse_correlation.pyx":160
 * 
 *             # Second partial derivative of correlation w.r.t p and q components
 ...
 */
      __pyx_t_9 = __pyx_v_p;
      __pyx_t_1 = __pyx_v_q;
      __pyx_t_13 = __pyx_v_index_pointer;
      *((double *) ( /* dim=2 */ ((char *) (((double *) ( /* dim=1 */ (( /* dim=0 */ (__pyx_v_matrix_data.data + __pyx_t_9 * __pyx_v_matrix_data.strides[0]) ) + __pyx_t_1 * __pyx_v_matrix_data.strides[1]) )) + __pyx_t_13)) )) = (((__pyx_v_d2_kernel * __pyx_v_dp_distance) * __pyx_v_dq_distance) + (__pyx_v_d1_kernel * __pyx_v_dpq_distance));

      /* "glearn/_correlation/_compute_sparse_correlation.pyx":165
 * 
 ...
 */
      ...
      if (__pyx_t_2) {
        ...
        /* "glearn/_correlation/_compute_sparse_correlation.pyx":167
 *             if q != p:
 *                 matrix_data[q, p, index_pointer] = \
 *                         matrix_data[p, q, index_pointer]             # <<<<<<<<<<<<<<
 */
        __pyx_t_13 = __pyx_v_p;
        __pyx_t_1 = __pyx_v_q;
        __pyx_t_9 = __pyx_v_index_pointer;

        /* "glearn/_correlation/_compute_sparse_correlation.pyx":166
 *             # Using symmetry of Hessian
 *             if q != p:
 *                 matrix_data[q, p, index_pointer] = \             # <<<<<<<<<<<<<<
 *                         matrix_data[p, q, index_pointer]
 */
        ...
        __pyx_t_15 = __pyx_v_p;
        __pyx_t_10 = __pyx_v_index_pointer;
        *((double *) ( /* dim=2 */ ((char *) (((double *) ( /* dim=1 */ (( /* dim=0 */ (__pyx_v_matrix_data.data + __pyx_t_14 * __pyx_v_matrix_data.strides[0]) ) + __pyx_t_15 * __pyx_v_matrix_data.strides[1]) )) + __pyx_t_10)) )) = (*((double *) ( /* dim=2 */ ((char *) (((double *) ( /* dim=1 */ (( /* dim=0 */ (__pyx_v_matrix_data.data + __pyx_t_13 * __pyx_v_matrix_data.strides[0]) ) + __pyx_t_1 * __pyx_v_matrix_data.strides[1]) )) + __pyx_t_9)) )));
...
static PyTypeObject __pyx_type___pyx_array = {
  ...
  "glearn._correlation._compute_sparse_correlation.array", /*tp_name*/
...
static PyTypeObject __pyx_type___pyx_MemviewEnum = {
  PyVarObject_HEAD_INIT(0, 0)
  "glearn._correlation._compute_sparse_correlation.Enum", /*tp_name*/
...
static PyTypeObject __pyx_type___pyx_memoryview = {
  PyVarObject_HEAD_INIT(0, 0)
  "glearn._correlation._compute_sparse_correlation.memoryview", /*tp_name*/
...
static PyTypeObject __pyx_type___pyx_memoryviewslice = {
  PyVarObject_HEAD_INIT(0, 0)
  "glearn._correlation._compute_sparse_correlation._memoryviewslice", /*tp_name*/
...
static int __pyx_pymod_exec__compute_sparse_correlation(PyObject* module); /*proto*/
static PyModuleDef_Slot __pyx_moduledef_slots[] = {
  {Py_mod_create, (void*)__pyx_pymod_create},
  {Py_mod_exec, (void*)__pyx_pymod_exec__compute_sparse_correlation},
  {0, NULL}
};
#endif
...
static __Pyx_StringTabEntry __pyx_string_tab[] = {
  ...
  {&__pyx_n_u_compute_sparse_correlation, __pyx_k_compute_sparse_correlation, sizeof(__pyx_k_compute_sparse_correlation), 0, 1, 0, 1},
  {&__pyx_n_u_compute_sparse_correlation_hessi, __pyx_k_compute_sparse_correlation_hessi, sizeof(__pyx_k_compute_sparse_correlation_hessi), 0, 1, 0, 1},
  {&__pyx_n_u_compute_sparse_correlation_jacob, __pyx_k_compute_sparse_correlation_jacob, sizeof(__pyx_k_compute_sparse_correlation_jacob), 0, 1, 0, 1},
...
static int __Pyx_modinit_function_export_code(void) {
  ...
  if (__Pyx_ExportFunction("compute_sparse_correlation", (void (*)(void))__pyx_f_6glearn_12_correlation_27_compute_sparse_correlation_compute_sparse_correlation, "double (__Pyx_memviewslice, __Pyx_memviewslice, int const , __Pyx_memviewslice, struct __pyx_obj_6glearn_7kernels_6kernel_Kernel *)") < 0) __PYX_ERR(0, 1, __pyx_L1_error)
  if (__Pyx_ExportFunction("compute_sparse_correlation_jacobian", (void (*)(void))__pyx_f_6glearn_12_correlation_27_compute_sparse_correlation_compute_sparse_correlation_jacobian, "void (__Pyx_memviewslice, int const , __Pyx_memviewslice, struct __pyx_obj_6glearn_7kernels_6kernel_Kernel *, int, int, __Pyx_memviewslice, __Pyx_memviewslice)") < 0) __PYX_ERR(0, 1, __pyx_L1_error)
  if (__Pyx_ExportFunction("compute_sparse_correlation_hessian", (void (*)(void))__pyx_f_6glearn_12_correlation_27_compute_sparse_correlation_compute_sparse_correlation_hessian, "void (__Pyx_memviewslice, int const , __Pyx_memviewslice, struct __pyx_obj_6glearn_7kernels_6kernel_Kernel *, int, int, __Pyx_memviewslice, __Pyx_memviewslice)") < 0) __PYX_ERR(0, 1, __pyx_L1_error)
  __Pyx_RefNannyFinishContext();
  return 0;
  __pyx_L1_error:;
  __Pyx_RefNannyFinishContext();
...
static int __Pyx_modinit_function_import_code(void) {
  ...
  __pyx_t_1 = PyImport_ImportModule("glearn._correlation._euclidean_distance"); if (!__pyx_t_1) __PYX_ERR(0, 1, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_1);
  if (__Pyx_ImportFunction(__pyx_t_1, "euclidean_distance", (void (**)(void))&__pyx_f_6glearn_12_correlation_19_euclidean_distance_euclidean_distance, "double (__Pyx_memviewslice, __Pyx_memviewslice, __Pyx_memviewslice, int const )") < 0) __PYX_ERR(0, 1, __pyx_L1_error)
  __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;
  __Pyx_RefNannyFinishContext();
  return 0;
  __pyx_L1_error:;
...
#if PY_MAJOR_VERSION < 3
__Pyx_PyMODINIT_FUNC init_compute_sparse_correlation(void) CYTHON_SMALL_CODE; /*proto*/
__Pyx_PyMODINIT_FUNC init_compute_sparse_correlation(void)
#else
__Pyx_PyMODINIT_FUNC PyInit__compute_sparse_correlation(void) CYTHON_SMALL_CODE; /*proto*/
__Pyx_PyMODINIT_FUNC PyInit__compute_sparse_correlation(void)
#if CYTHON_PEP489_MULTI_PHASE_INIT
{
...
static CYTHON_SMALL_CODE int __pyx_pymod_exec__compute_sparse_correlation(PyObject *__pyx_pyinit_module)
#endif
#endif
{
  PyObject *__pyx_t_1 = NULL;
  ...
  if (__pyx_m) {
    ...
    PyErr_SetString(PyExc_RuntimeError, "Module '_compute_sparse_correlation' has already been imported. Re-initialisation is not supported.");
    return -1;
  }
  #elif PY_MAJOR_VERSION >= 3
...
if (!__Pyx_RefNanny) {
...
#endif
  __Pyx_RefNannySetupContext("__Pyx_PyMODINIT_FUNC PyInit__compute_sparse_correlation(void)", 0);
  ...
  #else
  #if PY_MAJOR_VERSION < 3
  __pyx_m = Py_InitModule4("_compute_sparse_correlation", __pyx_methods, 0, 0, PYTHON_API_VERSION); Py_XINCREF(__pyx_m);
  #else
  ...
  #endif
  if (__pyx_module_is_main_glearn___correlation___compute_sparse_correlation) {
    if (PyObject_SetAttr(__pyx_m, __pyx_n_s_name_2, __pyx_n_s_main) < 0) __PYX_ERR(0, 1, __pyx_L1_error)
  }
  #if PY_MAJOR_VERSION >= 3
  {
    PyObject *modules = PyImport_GetModuleDict(); if (unlikely(!modules)) __PYX_ERR(0, 1, __pyx_L1_error)
    if (!PyDict_GetItemString(modules, "glearn._correlation._compute_sparse_correlation")) {
      if (unlikely(PyDict_SetItemString(modules, "glearn._correlation._compute_sparse_correlation", __pyx_m) < 0)) __PYX_ERR(0, 1, __pyx_L1_error)
    }
  }
  #endif
  /*--- Builtin init code ---*/
  ...
  /* "glearn/_correlation/_compute_sparse_correlation.pyx":18
 ...
 */
  ...
  __Pyx_GOTREF(__pyx_t_1);
  __Pyx_INCREF(__pyx_n_u_compute_sparse_correlation);
  __Pyx_GIVEREF(__pyx_n_u_compute_sparse_correlation);
  PyList_SET_ITEM(__pyx_t_1, 0, __pyx_n_u_compute_sparse_correlation);
  __Pyx_INCREF(__pyx_n_u_compute_sparse_correlation_jacob);
  __Pyx_GIVEREF(__pyx_n_u_compute_sparse_correlation_jacob);
  PyList_SET_ITEM(__pyx_t_1, 1, __pyx_n_u_compute_sparse_correlation_jacob);
  __Pyx_INCREF(__pyx_n_u_compute_sparse_correlation_hessi);
  __Pyx_GIVEREF(__pyx_n_u_compute_sparse_correlation_hessi);
  PyList_SET_ITEM(__pyx_t_1, 2, __pyx_n_u_compute_sparse_correlation_hessi);
  if (PyDict_SetItem(__pyx_d, __pyx_n_s_all, __pyx_t_1) < 0) __PYX_ERR(0, 18, __pyx_L1_error)
  __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;

  /* "glearn/_correlation/_compute_sparse_correlation.pyx":1
 ...
 */
  ...
  if (__pyx_m) {
    if (__pyx_d) {
      __Pyx_AddTraceback("init glearn._correlation._compute_sparse_correlation", __pyx_clineno, __pyx_lineno, __pyx_filename);
    }
    Py_CLEAR(__pyx_m);
  } else if (!PyErr_Occurred()) {
    PyErr_SetString(PyExc_ImportError, "init glearn._correlation._compute_sparse_correlation");
  }
  __pyx_L0:;
  __Pyx_RefNannyFinishContext();
  #if CYTHON_PEP489_MULTI_PHASE_INIT
