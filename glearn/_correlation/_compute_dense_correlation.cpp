...
/* BEGIN: Cython Metadata
{
    "distutils": {
        ...
        "language": "c++",
        "name": "glearn._correlation._compute_dense_correlation",
        "sources": [
            "./glearn/_correlation/_compute_dense_correlation.pyx"
        ]
    },
    "module_name": "glearn._correlation._compute_dense_correlation"
}
END: Cython Metadata */
...
#define __PYX_HAVE__glearn___correlation___compute_dense_correlation
#define __PYX_HAVE_API__glearn___correlation___compute_dense_correlation
/* Early includes */
#include "pythread.h"
#include <string.h>
#include <stdlib.h>
...
#define __Pyx_MODULE_NAME "glearn._correlation._compute_dense_correlation"
extern int __pyx_module_is_main_glearn___correlation___compute_dense_correlation;
int __pyx_module_is_main_glearn___correlation___compute_dense_correlation = 0;

/* Implementation of 'glearn._correlation._compute_dense_correlation' */
...
static const char __pyx_k_compute_dense_correlation[] = "compute_dense_correlation";
...
static const char __pyx_k_compute_dense_correlation_hessia[] = "compute_dense_correlation_hessian";
static const char __pyx_k_compute_dense_correlation_jacobi[] = "compute_dense_correlation_jacobian";
...
static PyObject *__pyx_n_u_compute_dense_correlation;
static PyObject *__pyx_n_u_compute_dense_correlation_hessia;
static PyObject *__pyx_n_u_compute_dense_correlation_jacobi;
...
/* "glearn/_correlation/_compute_dense_correlation.pyx":28
 * @boundscheck(False)
 * @wraparound(False)
...
static double __pyx_f_6glearn_12_correlation_26_compute_dense_correlation_compute_dense_correlation(__Pyx_memviewslice __pyx_v_point1, __Pyx_memviewslice __pyx_v_point2, int const __pyx_v_dimension, __Pyx_memviewslice __pyx_v_scale, struct __pyx_obj_6glearn_7kernels_6kernel_Kernel *__pyx_v_kernel) {
  double __pyx_v_distance;
  double __pyx_r;

  /* "glearn/_correlation/_compute_dense_correlation.pyx":38
 *     """
 * 
 ...
 */
  ...
  /* "glearn/_correlation/_compute_dense_correlation.pyx":40
 *     cdef double distance = euclidean_distance(point1, point2, scale, dimension)
 * 
 *     return kernel.cy_kernel(distance)             # <<<<<<<<<<<<<<
 * 
...
/* "glearn/_correlation/_compute_dense_correlation.pyx":49
 * @boundscheck(False)
 * @wraparound(False)
...
static void __pyx_f_6glearn_12_correlation_26_compute_dense_correlation_compute_dense_correlation_jacobian(__Pyx_memviewslice __pyx_v_points, int const __pyx_v_dimension, __Pyx_memviewslice __pyx_v_scale, struct __pyx_obj_6glearn_7kernels_6kernel_Kernel *__pyx_v_kernel, __Pyx_memviewslice __pyx_v_correlation_matrix_jacobian, int __pyx_v_i, int __pyx_v_j) {
  int __pyx_v_p;
  double __pyx_v_distance;
  ...
  /* "glearn/_correlation/_compute_dense_correlation.pyx":66
 * 
 ...
 */
  ...
  if (__pyx_t_1) {
    ...
    /* "glearn/_correlation/_compute_dense_correlation.pyx":67
 *     # The case at zero distance.
 *     if i == j:
 *         for p in range(dimension):             # <<<<<<<<<<<<<<
 *             correlation_matrix_jacobian[p, i, j] = 0.0
 ...
 */
    ...
    for (__pyx_t_4 = 0; __pyx_t_4 < __pyx_t_3; __pyx_t_4+=1) {
      ...
      /* "glearn/_correlation/_compute_dense_correlation.pyx":68
 *     if i == j:
 *         for p in range(dimension):
 *             correlation_matrix_jacobian[p, i, j] = 0.0             # <<<<<<<<<<<<<<
 *         return
 ...
 */
      ...
      __pyx_t_6 = __pyx_v_i;
      __pyx_t_7 = __pyx_v_j;
      *((double *) ( /* dim=2 */ ((char *) (((double *) ( /* dim=1 */ (( /* dim=0 */ (__pyx_v_correlation_matrix_jacobian.data + __pyx_t_5 * __pyx_v_correlation_matrix_jacobian.strides[0]) ) + __pyx_t_6 * __pyx_v_correlation_matrix_jacobian.strides[1]) )) + __pyx_t_7)) )) = 0.0;
    }

    /* "glearn/_correlation/_compute_dense_correlation.pyx":69
 *         for p in range(dimension):
 *             correlation_matrix_jacobian[p, i, j] = 0.0
 *         return             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  /* "glearn/_correlation/_compute_dense_correlation.pyx":72
 * 
 *     cdef double distance = euclidean_distance(
...
__pyx_v_distance = __pyx_f_6glearn_12_correlation_19_euclidean_distance_euclidean_distance(__pyx_t_8, __pyx_t_9, __pyx_v_scale, __pyx_v_dimension);

  /* "glearn/_correlation/_compute_dense_correlation.pyx":71
 *         return
 * 
 *     cdef double distance = euclidean_distance(             # <<<<<<<<<<<<<<
 *             points[i][:], points[j][:], scale, dimension)
 ...
 */
  ...
  /* "glearn/_correlation/_compute_dense_correlation.pyx":75
 * 
 *     # Derivative of kernel function w.r.t distance
 ...
 */
  ...
  /* "glearn/_correlation/_compute_dense_correlation.pyx":80
 ...
 */
  ...
  for (__pyx_t_4 = 0; __pyx_t_4 < __pyx_t_3; __pyx_t_4+=1) {
    ...
    /* "glearn/_correlation/_compute_dense_correlation.pyx":83
 * 
 *         # derivative of distance w.r.t the p-th component of scale
 ...
 */
    ...
    /* "glearn/_correlation/_compute_dense_correlation.pyx":84
 *         # derivative of distance w.r.t the p-th component of scale
 *         d1_distance = -(points[i, p] - points[j, p])**2 / \
 *             (distance * scale[p]**3)             # <<<<<<<<<<<<<<
 * 
 ...
 * 
 */
    __pyx_v_d1_distance = ((-pow(((*((double const  *) ( /* dim=1 */ ((char *) (((double const  *) ( /* dim=0 */ (__pyx_v_points.data + __pyx_t_7 * __pyx_v_points.strides[0]) )) + __pyx_t_6)) ))) - (*((double const  *) ( /* dim=1 */ ((char *) (((double const  *) ( /* dim=0 */ (__pyx_v_points.data + __pyx_t_5 * __pyx_v_points.strides[0]) )) + __pyx_t_10)) )))), 2.0)) / (__pyx_v_distance * pow(((double)(*((double const  *) ( /* dim=0 */ (__pyx_v_scale.data + __pyx_t_11 * __pyx_v_scale.strides[0]) )))), 3.0)));

    /* "glearn/_correlation/_compute_dense_correlation.pyx":87
 * 
 *         # Derivative of correlation
 ...
 */
    ...
    __pyx_t_5 = __pyx_v_j;
    *((double *) ( /* dim=2 */ ((char *) (((double *) ( /* dim=1 */ (( /* dim=0 */ (__pyx_v_correlation_matrix_jacobian.data + __pyx_t_11 * __pyx_v_correlation_matrix_jacobian.strides[0]) ) + __pyx_t_10 * __pyx_v_correlation_matrix_jacobian.strides[1]) )) + __pyx_t_5)) )) = (__pyx_v_d1_kernel * __pyx_v_d1_distance);
  }
...
/* "glearn/_correlation/_compute_dense_correlation.pyx":96
 * @boundscheck(False)
 * @wraparound(False)
...
static void __pyx_f_6glearn_12_correlation_26_compute_dense_correlation_compute_dense_correlation_hessian(__Pyx_memviewslice __pyx_v_points, int const __pyx_v_dimension, __Pyx_memviewslice __pyx_v_scale, struct __pyx_obj_6glearn_7kernels_6kernel_Kernel *__pyx_v_kernel, __Pyx_memviewslice __pyx_v_correlation_matrix_hessian, int __pyx_v_i, int __pyx_v_j) {
  int __pyx_v_p;
  int __pyx_v_q;
  double __pyx_v_distance;
  double __pyx_v_d1_kernel;
  ...
  /* "glearn/_correlation/_compute_dense_correlation.pyx":112
 * 
 *     # The case at zero distance
 *     if i == j:             # <<<<<<<<<<<<<<
 *         for p in range(dimension):
 ...
 */
  ...
  if (__pyx_t_1) {
    ...
    /* "glearn/_correlation/_compute_dense_correlation.pyx":113
 *     # The case at zero distance
 *     if i == j:
 *         for p in range(dimension):             # <<<<<<<<<<<<<<
 *             for q in range(dimension):
 ...
 */
    ...
    for (__pyx_t_4 = 0; __pyx_t_4 < __pyx_t_3; __pyx_t_4+=1) {
      ...
      /* "glearn/_correlation/_compute_dense_correlation.pyx":114
 *     if i == j:
 *         for p in range(dimension):
 *             for q in range(dimension):             # <<<<<<<<<<<<<<
 *                 correlation_matrix_hessian[p, q, i, j] = 0.0
 ...
 */
      ...
      for (__pyx_t_7 = 0; __pyx_t_7 < __pyx_t_6; __pyx_t_7+=1) {
        ...
        /* "glearn/_correlation/_compute_dense_correlation.pyx":115
 *         for p in range(dimension):
 *             for q in range(dimension):
 *                 correlation_matrix_hessian[p, q, i, j] = 0.0             # <<<<<<<<<<<<<<
 *         return
 ...
 */
        ...
        *((double *) ( /* dim=3 */ ((char *) (((double *) ( /* dim=2 */ (( /* dim=1 */ (( /* dim=0 */ (__pyx_v_correlation_matrix_hessian.data + __pyx_t_8 * __pyx_v_correlation_matrix_hessian.strides[0]) ) + __pyx_t_9 * __pyx_v_correlation_matrix_hessian.strides[1]) ) + __pyx_t_10 * __pyx_v_correlation_matrix_hessian.strides[2]) )) + __pyx_t_11)) )) = 0.0;
      }
    }

    /* "glearn/_correlation/_compute_dense_correlation.pyx":116
 *             for q in range(dimension):
 *                 correlation_matrix_hessian[p, q, i, j] = 0.0
 *         return             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  /* "glearn/_correlation/_compute_dense_correlation.pyx":119
 * 
 *     cdef double distance = euclidean_distance(
 *             points[i][:], points[j][:], scale, dimension)             # <<<<<<<<<<<<<<
 * 
...
__pyx_t_13.data = __pyx_v_points.data;
...
__pyx_v_distance = __pyx_f_6glearn_12_correlation_19_euclidean_distance_euclidean_distance(__pyx_t_12, __pyx_t_13, __pyx_v_scale, __pyx_v_dimension);

  /* "glearn/_correlation/_compute_dense_correlation.pyx":118
 *         return
 * 
 *     cdef double distance = euclidean_distance(             # <<<<<<<<<<<<<<
 *             points[i][:], points[j][:], scale, dimension)
 ...
 */
  ...
  /* "glearn/_correlation/_compute_dense_correlation.pyx":121
 *             points[i][:], points[j][:], scale, dimension)
 * 
 *     cdef double d1_kernel = kernel.cy_kernel_first_derivative(distance)             # <<<<<<<<<<<<<<
 ...
 */
  ...
  /* "glearn/_correlation/_compute_dense_correlation.pyx":122
 * 
 *     cdef double d1_kernel = kernel.cy_kernel_first_derivative(distance)
 *     cdef double d2_kernel = kernel.cy_kernel_second_derivative(distance)             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  /* "glearn/_correlation/_compute_dense_correlation.pyx":129
 ...
 */
  ...
  for (__pyx_t_4 = 0; __pyx_t_4 < __pyx_t_3; __pyx_t_4+=1) {
    ...
    /* "glearn/_correlation/_compute_dense_correlation.pyx":130
 * 
 *     for p in range(dimension):
 *         for q in range(p, dimension):             # <<<<<<<<<<<<<<
 * 
 ...
 */
    __pyx_t_5 = __pyx_v_dimension;
    __pyx_t_6 = __pyx_t_5;
    for (__pyx_t_7 = __pyx_v_p; __pyx_t_7 < __pyx_t_6; __pyx_t_7+=1) {
      __pyx_v_q = __pyx_t_7;

      /* "glearn/_correlation/_compute_dense_correlation.pyx":133
 * 
 *             # derivative of distance w.r.t the p-th component of scale
 ...
 */
      ...
      /* "glearn/_correlation/_compute_dense_correlation.pyx":134
 *             # derivative of distance w.r.t the p-th component of scale
 *             dp_distance = -(points[i, p] - points[j, p])**2 / \
 *                 (distance * scale[p]**3)             # <<<<<<<<<<<<<<
 * 
 ...
 * 
 */
      __pyx_v_dp_distance = ((-pow(((*((double const  *) ( /* dim=1 */ ((char *) (((double const  *) ( /* dim=0 */ (__pyx_v_points.data + __pyx_t_11 * __pyx_v_points.strides[0]) )) + __pyx_t_10)) ))) - (*((double const  *) ( /* dim=1 */ ((char *) (((double const  *) ( /* dim=0 */ (__pyx_v_points.data + __pyx_t_9 * __pyx_v_points.strides[0]) )) + __pyx_t_8)) )))), 2.0)) / (__pyx_v_distance * pow(((double)(*((double const  *) ( /* dim=0 */ (__pyx_v_scale.data + __pyx_t_14 * __pyx_v_scale.strides[0]) )))), 3.0)));

      /* "glearn/_correlation/_compute_dense_correlation.pyx":137
 * 
 *             # derivative of distance w.r.t the p-th component of scale
 *             if q == p:             # <<<<<<<<<<<<<<
 ...
 */
      ...
      if (__pyx_t_1) {
        ...
        /* "glearn/_correlation/_compute_dense_correlation.pyx":138
 *             # derivative of distance w.r.t the p-th component of scale
 *             if q == p:
 *                 dq_distance = dp_distance             # <<<<<<<<<<<<<<
 *             else:
 ...
 */
      ...
      /* "glearn/_correlation/_compute_dense_correlation.pyx":140
 *                 dq_distance = dp_distance
 *             else:
 *                 dq_distance = -(points[i, q] - points[j, q])**2 / \             # <<<<<<<<<<<<<<
 *                     (distance * scale[q]**3)
 ...
 */
      /*else*/ {
        ...
        /* "glearn/_correlation/_compute_dense_correlation.pyx":141
 *             else:
 *                 dq_distance = -(points[i, q] - points[j, q])**2 / \
 *                     (distance * scale[q]**3)             # <<<<<<<<<<<<<<
 * 
 ...
 * 
 */
        __pyx_v_dq_distance = ((-pow(((*((double const  *) ( /* dim=1 */ ((char *) (((double const  *) ( /* dim=0 */ (__pyx_v_points.data + __pyx_t_14 * __pyx_v_points.strides[0]) )) + __pyx_t_8)) ))) - (*((double const  *) ( /* dim=1 */ ((char *) (((double const  *) ( /* dim=0 */ (__pyx_v_points.data + __pyx_t_9 * __pyx_v_points.strides[0]) )) + __pyx_t_10)) )))), 2.0)) / (__pyx_v_distance * pow(((double)(*((double const  *) ( /* dim=0 */ (__pyx_v_scale.data + __pyx_t_11 * __pyx_v_scale.strides[0]) )))), 3.0)));
      }
      __pyx_L12:;

      /* "glearn/_correlation/_compute_dense_correlation.pyx":144
 * 
 *             # Second mixed derivative of distance w.r.t the p and q component
 *             if q == p:             # <<<<<<<<<<<<<<
 ...
 */
      ...
      if (__pyx_t_1) {
        ...
        /* "glearn/_correlation/_compute_dense_correlation.pyx":145
 *             # Second mixed derivative of distance w.r.t the p and q component
 *             if q == p:
 *                 dpq_distance = ((points[i, p] - points[j, p])**2 /             # <<<<<<<<<<<<<<
 *                                 (distance * scale[p]**3)) * \
 ...
 */
        ...
        /* "glearn/_correlation/_compute_dense_correlation.pyx":146
 *             if q == p:
 *                 dpq_distance = ((points[i, p] - points[j, p])**2 /
 *                                 (distance * scale[p]**3)) * \             # <<<<<<<<<<<<<<
 *                         (3.0 / scale[p] + dp_distance / distance)
 ...
 */
        ...
        /* "glearn/_correlation/_compute_dense_correlation.pyx":147
 *                 dpq_distance = ((points[i, p] - points[j, p])**2 /
 *                                 (distance * scale[p]**3)) * \
 *                         (3.0 / scale[p] + dp_distance / distance)             # <<<<<<<<<<<<<<
 *             else:
 ...
 *             else:
 */
        __pyx_v_dpq_distance = ((pow(((*((double const  *) ( /* dim=1 */ ((char *) (((double const  *) ( /* dim=0 */ (__pyx_v_points.data + __pyx_t_11 * __pyx_v_points.strides[0]) )) + __pyx_t_10)) ))) - (*((double const  *) ( /* dim=1 */ ((char *) (((double const  *) ( /* dim=0 */ (__pyx_v_points.data + __pyx_t_9 * __pyx_v_points.strides[0]) )) + __pyx_t_8)) )))), 2.0) / (__pyx_v_distance * pow(((double)(*((double const  *) ( /* dim=0 */ (__pyx_v_scale.data + __pyx_t_14 * __pyx_v_scale.strides[0]) )))), 3.0))) * ((3.0 / ((double)(*((double const  *) ( /* dim=0 */ (__pyx_v_scale.data + __pyx_t_15 * __pyx_v_scale.strides[0]) ))))) + (__pyx_v_dp_distance / __pyx_v_distance)));
 ...
 */
      ...
      /* "glearn/_correlation/_compute_dense_correlation.pyx":150
 *             else:
 *                 dpq_distance = ((points[i, p] - points[j, p])**2 /
 ...
 */
      /*else*/ {
        ...
        /* "glearn/_correlation/_compute_dense_correlation.pyx":149
 *                         (3.0 / scale[p] + dp_distance / distance)
 *             else:
 *                 dpq_distance = ((points[i, p] - points[j, p])**2 /             # <<<<<<<<<<<<<<
 *                                 (distance**2 * scale[p]**3)) * dq_distance
 ...
 * 
 */
        __pyx_v_dpq_distance = ((pow(((*((double const  *) ( /* dim=1 */ ((char *) (((double const  *) ( /* dim=0 */ (__pyx_v_points.data + __pyx_t_15 * __pyx_v_points.strides[0]) )) + __pyx_t_14)) ))) - (*((double const  *) ( /* dim=1 */ ((char *) (((double const  *) ( /* dim=0 */ (__pyx_v_points.data + __pyx_t_8 * __pyx_v_points.strides[0]) )) + __pyx_t_9)) )))), 2.0) / (pow(__pyx_v_distance, 2.0) * pow(((double)(*((double const  *) ( /* dim=0 */ (__pyx_v_scale.data + __pyx_t_10 * __pyx_v_scale.strides[0]) )))), 3.0))) * __pyx_v_dq_distance);
      }
      __pyx_L13:;

      /* "glearn/_correlation/_compute_dense_correlation.pyx":153
 * 
 *             # Second partial derivative of correlation w.r.t p and q components
 ...
 */
      ...
      *((double *) ( /* dim=3 */ ((char *) (((double *) ( /* dim=2 */ (( /* dim=1 */ (( /* dim=0 */ (__pyx_v_correlation_matrix_hessian.data + __pyx_t_10 * __pyx_v_correlation_matrix_hessian.strides[0]) ) + __pyx_t_9 * __pyx_v_correlation_matrix_hessian.strides[1]) ) + __pyx_t_8 * __pyx_v_correlation_matrix_hessian.strides[2]) )) + __pyx_t_14)) )) = (((__pyx_v_d2_kernel * __pyx_v_dp_distance) * __pyx_v_dq_distance) + (__pyx_v_d1_kernel * __pyx_v_dpq_distance));

      /* "glearn/_correlation/_compute_dense_correlation.pyx":158
 * 
 ...
 */
      ...
      if (__pyx_t_1) {
        ...
        /* "glearn/_correlation/_compute_dense_correlation.pyx":160
 *             if q != p:
 *                 correlation_matrix_hessian[q, p, i, j] = \
 *                         correlation_matrix_hessian[p, q, i, j]             # <<<<<<<<<<<<<<
 */
        ...
        /* "glearn/_correlation/_compute_dense_correlation.pyx":159
 *             # Using symmetry of Hessian
 *             if q != p:
 *                 correlation_matrix_hessian[q, p, i, j] = \             # <<<<<<<<<<<<<<
 *                         correlation_matrix_hessian[p, q, i, j]
 */
        ...
        *((double *) ( /* dim=3 */ ((char *) (((double *) ( /* dim=2 */ (( /* dim=1 */ (( /* dim=0 */ (__pyx_v_correlation_matrix_hessian.data + __pyx_t_15 * __pyx_v_correlation_matrix_hessian.strides[0]) ) + __pyx_t_11 * __pyx_v_correlation_matrix_hessian.strides[1]) ) + __pyx_t_16 * __pyx_v_correlation_matrix_hessian.strides[2]) )) + __pyx_t_17)) )) = (*((double *) ( /* dim=3 */ ((char *) (((double *) ( /* dim=2 */ (( /* dim=1 */ (( /* dim=0 */ (__pyx_v_correlation_matrix_hessian.data + __pyx_t_14 * __pyx_v_correlation_matrix_hessian.strides[0]) ) + __pyx_t_8 * __pyx_v_correlation_matrix_hessian.strides[1]) ) + __pyx_t_9 * __pyx_v_correlation_matrix_hessian.strides[2]) )) + __pyx_t_10)) )));
...
static PyTypeObject __pyx_type___pyx_array = {
  ...
  "glearn._correlation._compute_dense_correlation.array", /*tp_name*/
...
static PyTypeObject __pyx_type___pyx_MemviewEnum = {
  PyVarObject_HEAD_INIT(0, 0)
  "glearn._correlation._compute_dense_correlation.Enum", /*tp_name*/
...
static PyTypeObject __pyx_type___pyx_memoryview = {
  PyVarObject_HEAD_INIT(0, 0)
  "glearn._correlation._compute_dense_correlation.memoryview", /*tp_name*/
...
static PyTypeObject __pyx_type___pyx_memoryviewslice = {
  PyVarObject_HEAD_INIT(0, 0)
  "glearn._correlation._compute_dense_correlation._memoryviewslice", /*tp_name*/
...
static int __pyx_pymod_exec__compute_dense_correlation(PyObject* module); /*proto*/
static PyModuleDef_Slot __pyx_moduledef_slots[] = {
  {Py_mod_create, (void*)__pyx_pymod_create},
  {Py_mod_exec, (void*)__pyx_pymod_exec__compute_dense_correlation},
  {0, NULL}
};
#endif
...
static __Pyx_StringTabEntry __pyx_string_tab[] = {
  ...
  {&__pyx_n_u_compute_dense_correlation, __pyx_k_compute_dense_correlation, sizeof(__pyx_k_compute_dense_correlation), 0, 1, 0, 1},
  {&__pyx_n_u_compute_dense_correlation_hessia, __pyx_k_compute_dense_correlation_hessia, sizeof(__pyx_k_compute_dense_correlation_hessia), 0, 1, 0, 1},
  {&__pyx_n_u_compute_dense_correlation_jacobi, __pyx_k_compute_dense_correlation_jacobi, sizeof(__pyx_k_compute_dense_correlation_jacobi), 0, 1, 0, 1},
...
static int __Pyx_modinit_function_export_code(void) {
  ...
  if (__Pyx_ExportFunction("compute_dense_correlation", (void (*)(void))__pyx_f_6glearn_12_correlation_26_compute_dense_correlation_compute_dense_correlation, "double (__Pyx_memviewslice, __Pyx_memviewslice, int const , __Pyx_memviewslice, struct __pyx_obj_6glearn_7kernels_6kernel_Kernel *)") < 0) __PYX_ERR(0, 1, __pyx_L1_error)
  if (__Pyx_ExportFunction("compute_dense_correlation_jacobian", (void (*)(void))__pyx_f_6glearn_12_correlation_26_compute_dense_correlation_compute_dense_correlation_jacobian, "void (__Pyx_memviewslice, int const , __Pyx_memviewslice, struct __pyx_obj_6glearn_7kernels_6kernel_Kernel *, __Pyx_memviewslice, int, int)") < 0) __PYX_ERR(0, 1, __pyx_L1_error)
  if (__Pyx_ExportFunction("compute_dense_correlation_hessian", (void (*)(void))__pyx_f_6glearn_12_correlation_26_compute_dense_correlation_compute_dense_correlation_hessian, "void (__Pyx_memviewslice, int const , __Pyx_memviewslice, struct __pyx_obj_6glearn_7kernels_6kernel_Kernel *, __Pyx_memviewslice, int, int)") < 0) __PYX_ERR(0, 1, __pyx_L1_error)
  __Pyx_RefNannyFinishContext();
  return 0;
  __pyx_L1_error:;
  __Pyx_RefNannyFinishContext();
...
#if PY_MAJOR_VERSION < 3
__Pyx_PyMODINIT_FUNC init_compute_dense_correlation(void) CYTHON_SMALL_CODE; /*proto*/
__Pyx_PyMODINIT_FUNC init_compute_dense_correlation(void)
#else
__Pyx_PyMODINIT_FUNC PyInit__compute_dense_correlation(void) CYTHON_SMALL_CODE; /*proto*/
__Pyx_PyMODINIT_FUNC PyInit__compute_dense_correlation(void)
#if CYTHON_PEP489_MULTI_PHASE_INIT
{
...
static CYTHON_SMALL_CODE int __pyx_pymod_exec__compute_dense_correlation(PyObject *__pyx_pyinit_module)
#endif
#endif
{
  PyObject *__pyx_t_1 = NULL;
  ...
  if (__pyx_m) {
    ...
    PyErr_SetString(PyExc_RuntimeError, "Module '_compute_dense_correlation' has already been imported. Re-initialisation is not supported.");
    return -1;
  }
  #elif PY_MAJOR_VERSION >= 3
...
if (!__Pyx_RefNanny) {
...
#endif
  __Pyx_RefNannySetupContext("__Pyx_PyMODINIT_FUNC PyInit__compute_dense_correlation(void)", 0);
  ...
  #else
  #if PY_MAJOR_VERSION < 3
  __pyx_m = Py_InitModule4("_compute_dense_correlation", __pyx_methods, 0, 0, PYTHON_API_VERSION); Py_XINCREF(__pyx_m);
  #else
  ...
  #endif
  if (__pyx_module_is_main_glearn___correlation___compute_dense_correlation) {
    if (PyObject_SetAttr(__pyx_m, __pyx_n_s_name_2, __pyx_n_s_main) < 0) __PYX_ERR(0, 1, __pyx_L1_error)
  }
  #if PY_MAJOR_VERSION >= 3
  {
    PyObject *modules = PyImport_GetModuleDict(); if (unlikely(!modules)) __PYX_ERR(0, 1, __pyx_L1_error)
    if (!PyDict_GetItemString(modules, "glearn._correlation._compute_dense_correlation")) {
      if (unlikely(PyDict_SetItemString(modules, "glearn._correlation._compute_dense_correlation", __pyx_m) < 0)) __PYX_ERR(0, 1, __pyx_L1_error)
    }
  }
  #endif
  /*--- Builtin init code ---*/
  ...
  /* "glearn/_correlation/_compute_dense_correlation.pyx":18
 ...
 */
  ...
  __Pyx_GOTREF(__pyx_t_1);
  __Pyx_INCREF(__pyx_n_u_compute_dense_correlation);
  __Pyx_GIVEREF(__pyx_n_u_compute_dense_correlation);
  PyList_SET_ITEM(__pyx_t_1, 0, __pyx_n_u_compute_dense_correlation);
  __Pyx_INCREF(__pyx_n_u_compute_dense_correlation_jacobi);
  __Pyx_GIVEREF(__pyx_n_u_compute_dense_correlation_jacobi);
  PyList_SET_ITEM(__pyx_t_1, 1, __pyx_n_u_compute_dense_correlation_jacobi);
  __Pyx_INCREF(__pyx_n_u_compute_dense_correlation_hessia);
  __Pyx_GIVEREF(__pyx_n_u_compute_dense_correlation_hessia);
  PyList_SET_ITEM(__pyx_t_1, 2, __pyx_n_u_compute_dense_correlation_hessia);
  if (PyDict_SetItem(__pyx_d, __pyx_n_s_all, __pyx_t_1) < 0) __PYX_ERR(0, 18, __pyx_L1_error)
  __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;

  /* "glearn/_correlation/_compute_dense_correlation.pyx":1
 ...
 */
  ...
  if (__pyx_m) {
    if (__pyx_d) {
      __Pyx_AddTraceback("init glearn._correlation._compute_dense_correlation", __pyx_clineno, __pyx_lineno, __pyx_filename);
    }
    Py_CLEAR(__pyx_m);
  } else if (!PyErr_Occurred()) {
    PyErr_SetString(PyExc_ImportError, "init glearn._correlation._compute_dense_correlation");
  }
  __pyx_L0:;
  __Pyx_RefNannyFinishContext();
  #if CYTHON_PEP489_MULTI_PHASE_INIT
